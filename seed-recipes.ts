...
export function officialSeedRecipes(cafeId:string):Recipe[] {
  ...
  return [
    ...
    {id:'official-seed-03',cafeId,title:'초콜릿처럼 부드러운 에어로프레스',description:'짧은 침출과 부드러운 압력으로 초콜릿과 견과류 같은 단맛을 살렸어요.',equipment:'에어로프레스',beans:'17g',bean:{product:'브라질 세하도 펄프드 내추럴',roaster:'RATIO 셀렉션',origin:'브라질 세하도',process:'펄프드 내추럴',roast:'미디엄',dose:'17g'},baseVolumeMl:220,water:'220g',temperature:'88°C',duration:'1:45',photo:cover(2),publishedAt,steps:steps([
    ...
    {id:'official-seed-04',cafeId,title:'아침을 위한 클린 프렌치프레스',description:'긴 침출 뒤 표면의 미분을 걷어 내 묵직하지만 텁텁하지 않은 한 잔을 만들어요.',equipment:'프렌치프레스',beans:'24g',bean:{product:'과테말라 안티구아',roaster:'RATIO 셀렉션',origin:'과테말라 안티구아',process:'워시드',roast:'미디엄',dose:'24g'},baseVolumeMl:360,water:'360g',temperature:'94°C',duration:'5:00',photo:cover(3),publishedAt,steps:steps([
    ...
    {id:'official-seed-05',cafeId,title:'레몬처럼 상쾌한 아이스 V60',description:'진하게 추출한 커피를 얼음 위로 바로 식혀 산뜻하고 선명한 아이스 커피를 만들어요.',equipment:'V60',beans:'22g',bean:{product:'르완다 니아마셰케 워시드',roaster:'RATIO 셀렉션',origin:'르완다 니아마셰케',process:'워시드',roast:'라이트',dose:'22g'},baseVolumeMl:330,water:'210g',temperature:'93°C',duration:'2:20',photo:cover(4),publishedAt,steps:steps([
    ...
    {id:'official-seed-06',cafeId,title:'밤새 천천히 우린 콜드브루',description:'냉장 침출로 부드러운 단맛을 끌어낸 부담 없는 데일리 콜드브루예요.',equipment:'콜드브루 보틀',beans:'60g',bean:{product:'콜롬비아 우일라',roaster:'RATIO 셀렉션',origin:'콜롬비아 우일라',process:'워시드',roast:'미디엄',dose:'60g'},baseVolumeMl:700,water:'700g',temperature:'20°C',duration:'12시간',photo:cover(5),publishedAt,steps:steps([
    ...
    {id:'official-seed-07',cafeId,title:'카라멜 단맛의 모카포트',description:'쓴맛을 줄이고 카라멜 같은 농도와 단맛을 살리는 가정용 모카포트 레시피예요.',equipment:'모카포트',beans:'18g',bean:{product:'브라질·콜롬비아 블렌드',roaster:'RATIO 셀렉션',origin:'브라질·콜롬비아',process:'블렌드',roast:'다크',dose:'18g'},baseVolumeMl:150,water:'150g',temperature:'90°C',duration:'3:30',photo:cover(6),publishedAt,steps:steps([
