...
RATIO는 사용자가 Cafe를 만들고 커피 레시피를 게시·구독·실행할 수 있는 UGC 앱입니다. 광고, AdMob, 인앱결제, 구독 상품, 제3자 광고 추적을 사용하지 않습니다. ATT 권한을 요청하지 않습니다.
...
Apple로 가입한 사용자가 계정을 삭제하면 시스템 재인증을 거친 뒤 Apple 토큰을 해제하고, Storage의 사진·영상과 계정 데이터를 삭제합니다. 전체 과정이 성공한 뒤에만 로컬 세션을 제거합니다.
